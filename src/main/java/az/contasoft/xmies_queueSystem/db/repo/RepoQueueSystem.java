...
public interface RepoQueueSystem extends CrudRepository<QueueSystem,Long> {
    ...
    List<QueueSystem> findAllByEnteredDate(Date date);
    ...
    List<QueueSystem> findAllByEnteredDateGreaterThanEqual(Date date);
    List<QueueSystem> findAllByEnteredDateGreaterThanEqualAndIdPersonal(Date date, long idPersonal);
}
