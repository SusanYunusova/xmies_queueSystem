...
public class UpdateQueueSystemRequest {
    ...
    public UpdateQueueSystemRequest() {
    }

    @Override
    public String toString() {
        return "UpdateQueueSystemRequest{" +
    ...
    public UpdateQueueSystemRequest(long idQueueSystem, Date enteredDate, long idProtocol, long idDeparment, long idPersonal, long queueNo) {
        this.idQueueSystem = idQueueSystem;
        this.enteredDate = enteredDate;
        this.idProtocol = idProtocol;
        this.idDeparment = idDeparment;
